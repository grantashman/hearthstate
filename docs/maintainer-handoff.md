...
- Hosted provisioning is currently an operator step; public onboarding remains roadmap work. Owner-confirmed household export/deletion is implemented through the hosted portability boundary.
